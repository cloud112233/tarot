...
public class Constants {
    ...
    public static final String BOARD_UPDATE_BASEPATH = "100/version/self_design_padUpdate/";//自研主板升级基础路径
    public static final String MODULE_UPDATE_BASEPATH = "100/version/moduleUpdate/";//模块升级基础路径
    public static final String APP_UPDATE_BASEPATH = "100/version/apkUpdate/";//应用升级基础路径
	...
	public static final String SEARCH_UPDATE_CONFIG_DEVICE_GROUP_NO = "deviceGroupNo";
