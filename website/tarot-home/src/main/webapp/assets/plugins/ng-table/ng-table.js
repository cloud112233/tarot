    ...
    angular.module('ngTable').factory('NgTableParams', ['$q', '$log', '$filter', 'ngTableDefaults', 'ngTableDefaultGetData', 'ngTableEventsChannel', function($q, $log, $filter, ngTableDefaults, ngTableDefaultGetData, ngTableEventsChannel) {
        ...
        var NgTableParams = function(baseParameters, baseSettings) {
            ...
            this.generatePagesArray = function(currentPage, totalItems, pageSize, maxBlocks) {
                ...
                pages.totals = {
                    currentPage:totalItems>0?currentPage*pageSize-(pageSize-1):0,
                    totalItems:totalItems,
                    pageSize:totalItems>0?(currentPage*pageSize>totalItems?totalItems:currentPage*pageSize):0
                }
                pages.page = [];
...
angular.module('ngTable').run(['$templateCache', function ($templateCache) {
	...
	$templateCache.put('ng-table/pager.html', '<div class="ng-cloak ng-table-pager" ng-if="pages.totals.totalItems"> <div class="ng-table-counts btn-group pull-right"> <button ng-repeat="count in params.settings().counts" type="button" ng-class="{\'active\':params.count()==count}" ng-click="params.count(count)" class="btn btn-default"> <span ng-bind="count"></span> </button> </div> <div class="pull-left">显示&nbsp;{{pages.totals.currentPage}}&nbsp;-&nbsp;{{pages.totals.pageSize}}&nbsp;条，共&nbsp;{{pages.totals.totalItems}}&nbsp;条</div><ul class="pagination ng-table-pagination pull-right"><li> <a ng-click="params.page(1)" ng-hide="(pages.page.length-2) == 0" href=""">首页</a></li> <li ng-class="{\'disabled\': !page.active && !page.current, \'active\': page.current}" ng-repeat="page in pages.page" ng-switch="page.type"> <a ng-switch-when="prev" ng-click="params.page(page.number)" ng-hide="page.number == 1" href="">&lt;上一页</a> <a ng-switch-when="first" ng-click="params.page(page.number)" href=""><span ng-bind="page.number"></span></a> <a ng-switch-when="page" ng-click="params.page(page.number)" href=""><span ng-bind="page.number"></span></a> <a ng-switch-when="more" ng-click="params.page(page.number)" href="">&#8230;</a> <a ng-switch-when="last" ng-click="params.page(page.number)" href=""><span ng-bind="page.number"></span></a> <a ng-switch-when="next" ng-click="params.page(page.number)" ng-hide="{{page.number == pages.page[pages.page.length-2].number}}" href="">下一页&gt;</a> </li> <li> <a ng-click="params.page(pages.page.length-2)" ng-hide="(pages.page.length-2) == 0" href="">末页</a></li></ul> </div> ');
