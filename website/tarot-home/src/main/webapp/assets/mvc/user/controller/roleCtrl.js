 ...
 * roleCtrl - controller
 */
roleMgrCtrl.$inject = ['$scope', 'cTables','cfromly','cResource','$filter','$q'];

function roleMgrCtrl($scope, cTables,cfromly, cResource, $filter, $q) {
    ...
    $scope.submitPermission = function () {
        ...
        cResource.save('./roles/bindPermissions',{
